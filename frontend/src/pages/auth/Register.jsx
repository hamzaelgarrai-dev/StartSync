        ...
        <div className=' w-[42%] flex flex-col'>
             ...
             <form className='w-full' action="">
                ...
                <div className='flex flex-col  mb-3'>
                    ...
                    <input type='text' className=' h-12 rounded-4xl bg-[#F4F8FC] border border-[#D7D7D7] focus:outline-none focus:ring-1 focus:ring-blue-300 px-4' placeholder='Your Name'></input>
                </div>
                ...
                <div className='flex flex-col mb-4 '>
                    ...
                    <input type='password' className=' h-12 rounded-4xl bg-[#F4F8FC] border border-[#D7D7D7] focus:outline-none focus:ring-1 focus:ring-blue-300 px-4' placeholder='Confirm your Password'></input>
                </div>

                <div className='flex flex-col justify-center items-center space-y-3.5'>
                    <button className='w-full h-12 bg-[#0059F3] rounded-4xl flex justify-center items-center text-white cursor-pointer'>Sign Up</button>
