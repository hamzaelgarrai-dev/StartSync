  ...
  return (
    <div className=' w-full h-22 flex items-center justify-between mb-4'>
        ...
        <div className='w-28  flex justify-end'>
            <button className='w-26 h-12 bg-linear-to-b from-[#005BF8] to-[#0047C7]  rounded-4xl text-white text-[16px] cursor-pointer hover:from-[#0047C7] hover:to-[#0036A5] transition-all duration-300 ease-out hover:scale-95' >
            Sign Up
        </button>
        </div>
